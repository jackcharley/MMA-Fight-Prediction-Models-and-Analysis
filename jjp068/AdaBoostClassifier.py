...
print("Accuracy for 'out of box' AdaBoost classifier: "+ str(accuracy))
...
rand_grid = RandomizedSearchCV(AdaBoostClassifier(), params, cv = 5, scoring ='accuracy', n_iter= 10, random_state= 42)
...
print("Accuracy for optimised AdaBoost classifier: "+ str(metrics.accuracy_score(y_true,y_predict)))
